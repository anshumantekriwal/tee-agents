...
export async function getOnChainActions(wallet: WalletClientBase, plugins: PluginBase[]) {
...
function generateResponse(runtime: IAgentRuntime, context: string): Promise<string> {
    return generateText({
        runtime,
        context,
